...
# this is used only for triggering the right tokenization in the c2nl/inputters/utils.py file
# here we --dev_src points to the actual target file to translate
DATASET=human_dataset_input

function generate () {

echo "============Generating (Beam)============"
## this function outputs everything in the MODEL_DIR folder with suffix BEAM
...
do
    ...
    FILE_PATH=$p'_human_annotated_debug.code'
